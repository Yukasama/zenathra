...
export default function page() {
  return (
    <div className="px-10 md:px-20 lg:px-48 xl:px-80 py-10">
      ...
      <h1 className="text-3xl font-bold my-5">Interpretation and Definitions</h1>
      ...
      <ul>
        ...
        <li>
          <p className="my-5">
            ...
            &quot;Our&quot; in this Agreement) refers to {SITE.name}.
          </p>
        </li>
        <li>
          <p className="my-5">
        ...
        <li>
          <p className="my-5">
            ...
            <a href={`www.${SITE.name.toLowerCase()}.com`} rel="external nofollow noopener" target="_blank">
      ...
      <h1 className="text-3xl font-bold my-5">Collecting and Using Your Personal Data</h1>
      ...
      <ul>
        <li>
          <p className="my-5">Email address</p>
        </li>
        <li>
          <p className="my-5">Usage Data</p>
        </li>
      </ul>
      <h3>Usage Data</h3>
      ...
      <p className="my-5">We use both Session and Persistent Cookies for the purposes set out below:</p>
      <ul>
        <li>
          <p className="my-5">
      ...
      <p className="my-5">We may share Your personal information in the following situations:</p>
      <ul>
        <li>
      ...
      <h2 className="text-2xl font-bold my-5">Retention of Your Personal Data</h2>
      <p className="my-5">
      ...
      <h2 className="text-2xl font-bold my-5">Transfer of Your Personal Data</h2>
      <p className="my-5">
      ...
      <h2 className="text-2xl font-bold my-5">Disclosure of Your Personal Data</h2>
      ...
      <h2 className="text-2xl font-bold my-5">Security of Your Personal Data</h2>
      <p className="my-5">
      ...
      <h1 className="text-3xl font-bold my-5">Changes to this Privacy Policy</h1>
      <p className="my-5">
      ...
      <p className="my-5">If you have any questions about this Privacy Policy, You can contact us:</p>
      <ul>
        <li>
