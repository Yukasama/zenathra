...
export default function PortableSidebar() {
  ...
  return (
    <div
      className={`fixed left-0 top-0 h-screen w-screen bg-gray-100/50 opacity-0 transition-opacity duration-300 dark:bg-moon-300/50 ${
        open ? "opacity-100 z-30" : "-z-20"
      } hiding-sidebar`}>
      <div
        className={`sidebar fixed w-80 ${
          open ? "translate-x-0" : "-translate-x-96"
        } f-col h-full justify-between bg-gray-200 py-3 shadow-sm shadow-moon-100 duration-300 dark:bg-moon-700`}>
