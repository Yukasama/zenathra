import { getQuote, getImage } from "@/lib/stocks/client/getStocks";
...
export default async function Highlight({ symbol }: Props) {
  if (!symbol)
          ...
          <div className="f-col flex-1 gap-3">
            <div className="flex items-center gap-3">
              ...
              <div className="f-col">
                ...
                <p className="max-w-[220px] truncate text-[15px] font-medium text-gray-600">
                  {quote.name}
                </p>
              </div>
              <Price quote={quote} />
