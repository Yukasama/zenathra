...
import { corsairPlugin, chartOptions } from "./chartOptions";
  ...
  return (
    <ChartStructure>
      <div
        ...
        <div className="hidden h-[30px] items-center gap-1 rounded-md dark:bg-moon-400 dark:text-gray-300 md:flex">
          {isAll &&
              ...
              <button
                ...
                text-[13px] ${
                  time === frame
                    ...
                    : `${
                        isAll
                          ? "bg-gray-300 dark:bg-moon-200"
                          : "bg-gray-100 dark:bg-moon-300"
                      }`
                }`}>
                <p
                  className={`${
                    !isAll && time !== frame && "text-gray-800/50"
