...
export default function StockMetrics({ stock }: Props) {
  return (
    <div>
      <div className="group flex animate-appear-up items-center gap-2 rounded-md p-2 px-5 hover:bg-slate-200 dark:hover:bg-moon-400">
        <p className="w-7 text-[13px] font-medium">P/E</p>
        <div className="h-4 w-40 rounded-full bg-slate-200 transition-transform group-hover:scale-x-[1.03] group-hover:bg-slate-300 dark:bg-moon-100 dark:group-hover:bg-moon-200">
