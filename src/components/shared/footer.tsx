...
export default function Footer() {
  return (
    <div className="f-col w-full justify-between gap-8 bg-slate-300/50 px-10 xl:px-60 py-4 pt-7 shadow-sm dark:bg-zinc-600 dark:shadow-zinc-100">
      ...
      <div className="f-col gap-3">
        <div className="h-[1px] bg-slate-300 dark:bg-zinc-100"></div>
