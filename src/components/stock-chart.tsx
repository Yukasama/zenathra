...
export function StockChartStructure({
  size = "lg",
  className,
  isLoading,
  children,
...
export function StockChartLoading({
  size = "lg",
  className,
}: ChartStructureProps) {
  return <StockChartStructure size={size} className={className} isLoading />;
}
...
export default function StockChart({
  ...
  return (
    <StockChartStructure size={size} className={className}>
